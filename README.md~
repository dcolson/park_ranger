...
Welcome to Park Ranger! In this game, you must keep out the goblins from your humble village by shooting stones at them. This document is to make sure you can run the program and play the game okay!
...
Quickly, some basic controls for the game. Move with the arrows, and with the mouse, and shoot by clicking. Kill all the goblins!# park_ranger
